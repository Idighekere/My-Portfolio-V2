...
const ProjectCard = ({ featured }: Props) => {
    ...
    return (
        <div className="//bg-custom-gradient p-[2px] rounded-lg shadow-light h-full" data-aos="zoom-in-up">
            <div className={` hover:scale-[1.01] transform transition-transform ease-in-out  flex lg:cgap-8 flex-col  border-2 border-primary-blue/40 rounded-lg hover:shadow-lg hover:shadow-blue-shade/50 duration-300 text-soft-white ${pathname === projects ? "lg:flex-col" : "lg:flex-row"}`}>
