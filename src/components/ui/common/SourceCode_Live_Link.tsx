...
const SourceCodeLiveLink = ({codeLink,liveLink}:{codeLink:string, liveLink:string}) => {
  ...
  { codeLink && (
    <Link
      href={ codeLink}
      className={`px-1 py-1 rounded-full   hover:text-primary-blue border hover:border-primary-blue text-soft-white/85 shadow-primary-blue hover:shadow-md  duration-200 hidden/ w-full flex items-center gap-3 md:gap-4 justify-center`}
    >
      {/* <button className=""> */}
