            ...
            <div>
                ...
                <div key={project.id}>
                    ...
                    <article className="">
                        ...
                        {/* IMAGE GALLERY */}
                        <h2 className=" font-[500] text-xl">Gallery</h2>

                        <div className="grid gap-2 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                            {project.images.map(image => (<div key={`${image}-${image.length + 1}`} className="relative h-full sm:h-48 lg:h-72 pt-[56.25%] py-3 "><Image src={image} alt={image} fill className="rounded-md" /></div>))}
                        </div>
                ...
                <div className="flex justify-center mb-2 flex-col mt-5">
                    ...
                    <p></p>
                    <ShareIcons shareLink={project.slug} />
                </div>            </div >
        </ main >
    );
};
