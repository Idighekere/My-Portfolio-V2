...
const Page = (props: any) => {
    ...
    return (
        <main>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 .grid-flow-dense .grid-row-auto auto-rows-fr gap-4" style={{ gridAutoRows: "auto" }}>{filteredProjects.map(project => (<ProjectCard featured={project} key={project} />))}</div>
